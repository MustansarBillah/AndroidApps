...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.getViewTreeObserver().addOnScrollChangedListener(() -> swipeRefreshLayout.setEnabled(webView.getScrollY() == 0));

        webView.setDownloadListener((s, s1, s2, s3, l) -> Dexter.withActivity(MainActivity.this)
    ...
    public void onBackPressed() {
        ...
        else
        {
            ...
            builder.setTitle("Are You Sure You Want To Exit Or Share?")
                    ...
                    .setNegativeButton("Share", (dialog, which) -> {
                        ...
                        String body = "Download This App & Watch MTAU Exclusive Videos."+"\n"+""+strAppLink;
                        String subject = "WuW";
                        intentInvite.putExtra(Intent.EXTRA_SUBJECT, subject);
                        intentInvite.putExtra(Intent.EXTRA_TEXT, body);
                        startActivity(Intent.createChooser(intentInvite, "Share using"));
                    })
                    .setPositiveButton("Exit", (dialogInterface, i) -> finishAffinity()).show();
        }
    }
    ...
    public void checkConnection(){
        ...
        String webUrl = "https://whatyouwant.lk/appdata/";
        if(wifi.isConnected()){
